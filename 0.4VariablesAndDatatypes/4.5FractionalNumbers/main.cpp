...
int main(){
    ...
    //Scientific notation
    //What we have seen so far in ters of floating point types
    //is fixed notation. There is another notation, scientific
    //that is handy if you have really huge numbers or smallnumbers
    //to represent
    ...
    double number7 {1.924e8};            // Can ommit the lower the 00023
                                         // for simplicity if our application allow
